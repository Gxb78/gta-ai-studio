...
3. **v0.3 (en cours)** : habillage — faits : titres superposés (styles, position, taille, timing, aperçu direct, piste Titres manipulable dans la timeline et export FFmpeg). Restent : musique, transitions simples, sous-titres automatiques (tâche de fond, jamais dans la boucle d'interaction).
