...
3. **v0.3 (en cours)** : habillage — faits : titres superposés (styles, position, taille, timing, fondus d'opacité, aperçu direct, piste Titres manipulable dans la timeline et export FFmpeg), fondus vidéo au noir par clip avec parité aperçu/export. Restent : musique, autres transitions simples, sous-titres automatiques (tâche de fond, jamais dans la boucle d'interaction).
