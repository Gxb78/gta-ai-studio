...
3. **v0.3 (en cours)** : habillage — faits : titres superposés (styles, position, taille, timing, fondus d'opacité, aperçu direct, piste Titres manipulable dans la timeline et export FFmpeg), fondus vidéo au noir par clip avec parité aperçu/export, fondus enchaînés vidéo centrés sur les cuts avec poignées source. Restent : fondu audio associé aux transitions, musique, autres transitions simples, sous-titres automatiques (tâche de fond, jamais dans la boucle d'interaction).
